...
model = resnet.ResnetBuilder.build_resnet_18((img_channels, img_rows,
                                                    img_cols), nb_classes
                                                  )
...
'''
plt.subplot(2,1,1)
plt.plot(epoch,FirstTrain.history['loss'], 'bo-.', label="Training loss")
plt.plot(epoch,FirstTrain.history['val_loss'],'ro-.', label="validation loss")
plt.legend(loc='upper right')

final_loss = FirstTrain.history['loss'][-1]
...
#'''
#plt.subplot(2,1,2)
plt.plot(epoch,FirstTrain.history['acc'], 'bo-.', label="Training accuracy")
plt.plot(epoch,FirstTrain.history['val_acc'],'ro-.', label="validation accuracy")
plt.legend(loc='lower right')

final_accuracy = FirstTrain.history['acc'][-1]
